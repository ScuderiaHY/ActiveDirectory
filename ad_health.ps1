...
'###################################################
	...
	minHDDfree = 10 'Minimun % HDD FreeSpace to mark as red/error
	minRAMfree = 10 'Minimun % RAM FreeSpace to mark as red/error
	...
	pathReportOutput = "c:\temp\AD-health-summary.html" 'Path and name for the output file
	
	'E-mail settings, edit by your own
	emailSubject = "Active Directory Health Summary"
	emailFrom = "test07@clmt.com"
	emailTo = "matt.yeager@@calumetspecialty.com"
	emailCc = "" 
	emailPort = 25
	emailAuth = 1	
	emailSenderUser = "test07@clmt.com"
	emailSenderPassword = "Butt0nM@X!!"
	emailServer = "mailcas.calumetlubricants.com"
	emailSSL = False
